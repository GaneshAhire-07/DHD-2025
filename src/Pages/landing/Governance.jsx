...
const images = {
  supervisorBoard: "https://picsum.photos/seed/dhd-governance-board/800/600",
  corporateGovernance: "https://picsum.photos/seed/dhd-governance-corporate/800/600",
  boardCommittees: "https://picsum.photos/seed/dhd-governance-committees/800/600",
};
    ...
    <div className="bg-slate-50 font-sans text-slate-800">
      ...
      <section className="-mt-10 relative z-10 mx-auto max-w-4xl bg-white rounded-2xl shadow-2xl text-center px-6 py-12">
        <h2 className="text-2xl md:text-3xl font-semibold mb-4">
          Our Framework for <span className="bg-gradient-to-r from-indigo-400 to-purple-500 bg-clip-text text-transparent">Ethical Leadership</span>
        </h2>
        <p className="text-slate-500 max-w-xl mx-auto">
          DHD is committed to the highest standards of corporate governance, ensuring transparency, accountability, and effective decision-making.
        </p>
      </section>
      ...
      <main className="max-w-7xl mx-auto py-12 sm:px-6 lg:px-8">
        ...
        >
          <p>
            DHD is governed by a Board of Directors which is made up of both Executive and Non Executive Directors. The independent Non-executive directors help to bring impartiality into the decision making process (the term Non Executive director refers to those members of the Board who are not part of the employed management team but who provide a range of skills and experience to the Board).
          </p>
          <p>
          ...
          <p>
            The Board recognises and embraces the benefits of having a <strong>diverse Board</strong> which utilises a range of factors including skills, industry experience, background, race, gender and the other characteristics, experience and qualities of its Directors. Giving specific regard to gender ratios, there are <strong>two female directors</strong> on the Board. It is important to note that all Board appointments are made on the basis of individual competence, skills and expertise measured against identified objective criteria. Appointment is therefore based on merit.
          </p>
          <p>
            Meetings take place on a monthly basis, or such other time as required, to carry out the Group’s business. The Board does not normally meet in August or December. The Board delegates a number of authorities to various Board Committees and Subsidiary Company Boards.
          </p>
          <p>
            In discharging its responsibilities to be accountable to the Society’s Members for the operation of the Society, the Board regards good corporate governance as extremely important. The revised US Corporate Governance Code (the Code).
          </p>
        </InfoSection>
        ...
        <section className="bg-white shadow-lg rounded-xl mb-12 p-8 md:p-12">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-2xl font-semibold text-gray-800 mb-2">Summary of the Chairman's Role</h3>
              <ul className="list-disc list-inside text-gray-600 space-y-2">
                ...
                <li>Together with the other Board of Directors, ensure that the Board takes collective responsibility for the sustainable and long-term success of the Society by ensuring a challenging strategic plan is in place, along with a sound framework for risk management;</li>
                <li>To ensure the Board comprises members with the appropriate skills, independence, experience and knowledge to enable it to discharge its duties and responsibilities effectively.</li>
              </ul>
            </div>
            <div>
              <h3 className="text-2xl font-semibold text-gray-800 mb-2">Summary of the Chief Executive's Role</h3>
              <ul className="list-disc list-inside text-gray-600 space-y-2">
                <li>Together with the support of other Executive members and the wider board, ensure that a robust and challenging strategic plan is in place that will support the long-term success of the Society;</li>
                <li>Together with the support of the other Executive members, direct and coordinate the management of the Groups operations;</li>
                <li>Together with the other Executive team members, lead the Executive Risk Committee to monitor the Group's risk profile and performance and oversight of the Group's risk management committees;</li>
                <li>To provide leadership to colleagues at all levels of our Group to motivate and inspire them to do the best for our Society;</li>
                <li>To establish and maintain effective working relationships with regulators, the Government, industry sector analysts, trade organisations and the media and strategically influence and lobby these bodies, as and when appropriate, in the best interests of the Group;</li>
                <li>To promote the interests of the Society’s key stakeholders – Members, Colleagues, Clients and the Communities in which it operates;</li>
                <li>To promote the Group, its good corporate image and social standing in the UK financial services industry.</li>
              </ul>
            </div>
            <div className="md:col-span-2">
              <h3 className="text-2xl font-semibold text-gray-800 mb-2">Summary of the Senior Independent Director's Role</h3>
              <ul className="list-disc list-inside text-gray-600 space-y-2">
                <li>To support the Society Chair, to ensure they are successful in achieving their objectives;</li>
                <li>To lead on an annual review of the Chairman’s performance;</li>
                <li>Available to support directors if they have concerns where the usual channels have failed to resolve these issue or for which such contact may not be appropriate;</li>
                <li>Acts as a trusted intermediary for other directors when necessary.</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white shadow-lg rounded-xl mb-12 p-8 md:p-12">
          ...
          <h3 className="text-2xl font-semibold text-gray-800 mb-3">Introduction</h3>
          <p className="text-slate-600 mb-4">
          ...
          <h3 className="text-2xl font-semibold text-gray-800 mb-3">Organisation's Structure</h3>
          <p className="text-slate-600 mb-4">
          ...
          <h3 className="text-2xl font-semibold text-gray-800 mb-3">Our Business</h3>
          <p className="text-slate-600 mb-4">
          ...
          <h3 className="text-2xl font-semibold text-gray-800 mb-3">Responsibilities</h3>
          <p className="text-slate-600 mb-4">
          ...
          <h3 className="text-2xl font-semibold text-gray-800 mb-3">Supply Chain Risk</h3>
          <p className="text-slate-600 mb-4">
          ...
          <ul className="list-disc list-inside text-slate-600 mb-4 ml-4">
            <li>IT and electronics manufacture including the disposal, dismantling and recycling stages;</li>
          ...
          <h3 className="text-2xl font-semibold text-gray-800 mb-3">Our Policies on Slavery and Human Trafficking</h3>
          <p className="text-slate-600 mb-4">
          ...
          <h3 className="text-2xl font-semibold text-gray-800 mb-3">Further Steps</h3>
          <p className="text-slate-600 mb-4">
          ...
          <ul className="list-disc list-inside text-slate-600 mb-4 ml-4">
            <li>Continue to ensure all of our supplier contracts (both existing and new) contain an anti-slavery clause, this clause, which flows down through all layers of our supply chain, prohibits suppliers and their employees from engaging in slavery and human trafficking;</li>
            <li>Review of existing training for all colleagues;</li>
            <li>Continue to review, update and develop new Procurement & Supplier Management policies and procedures (including risk assessment of suppliers) to address and incorporate provisions of the Act.</li>
          </ul>
        </section>
      </main>
    </div>
